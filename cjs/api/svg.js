...
exports.drawSvg = exports.transformationToMatrix = exports.combineMatrix = void 0;
...
const transformationToMatrix = (name, args) => {
    switch (name) {
        ...
        case 'rotate': {
            ...
            const t1 = (0, exports.transformationToMatrix)('translate', [x, y]);
            const t2 = (0, exports.transformationToMatrix)('translate', [-x, -y]);
            ...
            return (0, exports.combineMatrix)((0, exports.combineMatrix)(t1, r), t2);
        }
        case 'skewY':
        case 'skewX': {
            // [1 tan(a) 0 1 0 0]
        ...
        case 'matrix': {
            ...
            const r = (0, exports.transformationToMatrix)('scale', [1, -1]);
            const m = [a, b, c, d, e, f];
            return (0, exports.combineMatrix)((0, exports.combineMatrix)(r, m), r);
        }
        default:
            return matrix_1.identityMatrix;
    }
};
exports.transformationToMatrix = transformationToMatrix;
const combineTransformation = (matrix, name, args) => (0, exports.combineMatrix)(matrix, (0, exports.transformationToMatrix)(name, args));
...
const parseBlendMode = (blendMode) => {
    switch (blendMode) {
        case 'normal':
            return PDFPageOptions_1.BlendMode.Normal;
        case 'multiply':
            return PDFPageOptions_1.BlendMode.Multiply;
        case 'screen':
            return PDFPageOptions_1.BlendMode.Screen;
        case 'overlay':
            return PDFPageOptions_1.BlendMode.Overlay;
        case 'darken':
            return PDFPageOptions_1.BlendMode.Darken;
        case 'lighten':
            return PDFPageOptions_1.BlendMode.Lighten;
        case 'color-dodge':
            return PDFPageOptions_1.BlendMode.ColorDodge;
        case 'color-burn':
            return PDFPageOptions_1.BlendMode.ColorBurn;
        case 'hard-light':
            return PDFPageOptions_1.BlendMode.HardLight;
        case 'soft-light':
            return PDFPageOptions_1.BlendMode.SoftLight;
        case 'difference':
            return PDFPageOptions_1.BlendMode.Difference;
        case 'exclusion':
            return PDFPageOptions_1.BlendMode.Exclusion;
        default:
            return undefined;
    }
};
...
const drawSvg = (page, svg, options) => {
    const pdfSvg = typeof svg === 'string' ? new PDFSvg_1.default(svg) : svg;
    if (!pdfSvg.svg)
        return;
    const size = page.getSize();
    const svgNode = (0, node_html_better_parser_1.parse)(pdfSvg.svg).querySelector('svg');
    if (!svgNode) {
