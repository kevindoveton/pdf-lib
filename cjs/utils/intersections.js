...
const Arc_1 = tslib_1.__importDefault(require("./elements/Arc"));
const Circle_1 = tslib_1.__importDefault(require("./elements/Circle"));
const Ellipse_1 = tslib_1.__importDefault(require("./elements/Ellipse"));
const Line_1 = tslib_1.__importDefault(require("./elements/Line"));
const Plot_1 = tslib_1.__importDefault(require("./elements/Plot"));
const Point_1 = tslib_1.__importDefault(require("./elements/Point"));
const Rectangle_1 = tslib_1.__importDefault(require("./elements/Rectangle"));
const Segment_1 = tslib_1.__importDefault(require("./elements/Segment"));
...
const intersection = (A, B) => (0, exports.intersections)(A, B)[0];
exports.intersection = intersection;
const intersectionsLine = (A, B) => {
    if (B instanceof Line_1.default)
        return (0, exports.intersectionLine)(A, B);
    else if (B instanceof Segment_1.default) {
        return (0, exports.intersectionLine)(A, B.getLine()).filter((P) => B.includes(new Point_1.default(P)));
    }
    else if (B instanceof Circle_1.default)
        return (0, exports.intersectionCircleLine)(B, A);
...
const intersectionsEllipse = (A, B) => {
    if (B instanceof Line_1.default)
...
const intersectionsLineAndEllipse = (A, B) => {
...
const intersectionsPlot = (A, B) => {
    ...
    // @ts-ignore
    const inters = segments.map((s) => (0, exports.intersections)(s, B)).flat();
    return inters;
};
const intersectionsRectangle = (A, B) => {
    const P1 = A.getCoords();
    const P3 = A.getEnd();
    const P2 = { x: P1.x, y: P3.y };
    const P4 = { x: P3.x, y: P1.y };
    return (0, exports.intersections)(new Plot_1.default([P1, P2, P3, P4, P1]), B);
};
const intersectionCircleLine = (A, B) => {
    const rA = A.ray();
    const O = A.center();
...
const intersectionCircle = (A, B) => {
    ...
    // The intersections belong to an orthogonal axis
        ...
        return (0, exports.intersectionCircleLine)(A, new Line_1.default(H, H.plus((0, maths_1.orthogonal)(axis))));
    }
};
exports.intersectionCircle = intersectionCircle;
const intersectionsCircle = (A, B) => {
    if (B instanceof Circle_1.default)
        return (0, exports.intersectionCircle)(A, B);
    else if (B instanceof Line_1.default)
        return (0, exports.intersectionCircleLine)(A, B);
    else if (B instanceof Segment_1.default) {
        return (0, exports.intersectionCircleLine)(A, B.getLine()).filter((P) => B.includes(new Point_1.default(P)));
    }
    else if (B instanceof Arc_1.default) {
        return (0, exports.intersectionCircle)(A, B.getCircle()).filter((P) => B.includes(new Point_1.default(P)));
    }
    else if (B instanceof Plot_1.default)
        return intersectionsPlot(B, A);
    else if (B instanceof Rectangle_1.default)
...
const getIntersections = (elements) => {
    const checked = [];
    const inters = [];
    elements.forEach((elt) => {
        checked.forEach((e) => inters.push(...(0, exports.intersections)(e, elt)));
        checked.push(elt);
    });
    return inters;
};
